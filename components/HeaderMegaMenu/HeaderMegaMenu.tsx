      ...
      <UnstyledButton className={classes.subLink} key={item.title}>
        <Group noWrap align="flex-start">
          <ThemeIcon size={34} variant="default" radius="md">
            <item.icon size={rem(22)} color="red" />
          </ThemeIcon>
          <div>
            <Text size="sm" fw={500}>
              {item.title}
                ...
                <HoverCard.Dropdown sx={{ overflow: 'hidden' }}>
                  ...
                  <div className={classes.dropdownFooter}>
                    <Group position="apart">
                      ...
                      <Button variant="default">Loren Ipsum</Button>
                    </Group>
                  </div>
                </HoverCard.Dropdown>
              </HoverCard>
              <a href="#" className={classes.link} color="dimmed">
              <Text size="m" color="dimmed">
                About
              </Text>
              </a>
          ...
          <ScrollArea h={`calc(100vh - ${rem(60)})`} mx="-md">
            ...
            <UnstyledButton className={classes.link} onClick={toggleLinks}>
              <Center inline>
                ...
                <IconChevronDown size={16} color="vaktovian-red.8" />
              </Center>
            </UnstyledButton>
            ...
            <Divider my="sm" color={theme.colorScheme === 'dark' ? theme.colors.red[9] : theme.colors.gray[1]} />
